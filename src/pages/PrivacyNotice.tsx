      ...
      <div className="min-h-screen bg-encourager-background">
        ...
        <main className="max-w-4xl mx-auto px-4 py-8">
          <div className="bg-white rounded-lg shadow-sm p-8">
            <h1 className="heading-3 mb-8">Privacy Notice</h1>
            
            <div className="prose prose-slate max-w-none space-y-6">
              <div>
                <h2 className="text-2xl font-normal mt-8 mb-4 font-oswald text-black">Who We Are</h2>
                <p>
              ...
              <div>
                <h2 className="text-2xl font-normal mt-8 mb-4 font-oswald text-black">What Information We Collect</h2>
              ...
              <div>
                <h2 className="text-2xl font-normal mt-8 mb-4 font-oswald text-black">Why We Collect This Information</h2>
              ...
              <div>
                <h2 className="text-2xl font-normal mt-8 mb-4 font-oswald text-black">Legal Basis for Processing</h2>
